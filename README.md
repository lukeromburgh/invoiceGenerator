...
<p>
  Clone the repository and open the `index.html` file in any browser to use the
  site locally.
</p>
...
<h3>Documentation</h3>
<p>
  Extensive documentation has been provided for users to understand how to
  interact with the website.
</p>

<h3>Media</h3>
<p>
  All images and media content used are sourced from royalty-free platforms or
  self-created.
</p>
...
<p>
  Special thanks to the bootcamp instructors and peers for guidance and
  feedback.
</p>
